                ...
                <table class="table productTable">
                    ...
                    <tbody>
                        ...
                        @foreach($allProduct as $data)
                            ...
                            <td>
                                <a href="{{ Route('edit', $data->id) }}" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>

                                <button data-toggle="modal" data-target="#delete{{ $data->id }}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="{{ Route('delete',$data->id) }}" class="btn btn-danger">Conform</a>
      </div>
    </div>
  </div>
</div>
